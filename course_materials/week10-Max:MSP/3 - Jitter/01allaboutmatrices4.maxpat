	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 953.0, 412.0, 324.0, 27.0 ],
					"numoutlets" : 2,
					"id" : "obj-51",
					"fontsize" : 18.0,
					"outlettype" : [ "jit_matrix", "" ],
					"presentation_rect" : [ 953.0, 412.0, 0.0, 0.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.conway",
					"numinlets" : 1,
					"patching_rect" : [ 708.0, 462.0, 90.0, 27.0 ],
					"numoutlets" : 2,
					"id" : "obj-45",
					"fontsize" : 18.0,
					"outlettype" : [ "jit_matrix", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.matrix bob 1 char 80 60 @planemap 2",
					"numinlets" : 1,
					"patching_rect" : [ 594.0, 144.0, 336.0, 27.0 ],
					"numoutlets" : 2,
					"id" : "obj-11",
					"fontsize" : 18.0,
					"outlettype" : [ "jit_matrix", "" ],
